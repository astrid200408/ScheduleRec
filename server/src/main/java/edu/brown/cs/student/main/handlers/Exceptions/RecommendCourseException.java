package edu.brown.cs.student.main.handlers.Exceptions;
...
public class RecommendCourseException extends Exception {
  ...
  public RecommendCourseException(String message) {
    super(message); // Exception message
    this.cause = null;
  }

  public RecommendCourseException(String message, Throwable cause) {
    super(message); // Exception message
    this.cause = cause;
  }
